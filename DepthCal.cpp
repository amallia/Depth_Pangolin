...
void DepthCal::operator() (int qn, pairlists& pls, lptrArray& lps, const int topK, QpResult* res) {
	...
	while (docid_s != NULL)
  	...
  	string pair_dir = CONSTS::cr_results + pls.pairnames.at(k);
